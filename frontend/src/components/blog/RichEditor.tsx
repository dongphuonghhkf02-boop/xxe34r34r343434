    ...
    <div className={[styles.shell, className].filter(Boolean).join(" ")} data-testid="rich-editor">
      <div className={styles.toolbar} role="toolbar">
        ...
        <select
          ...
          title="Шрифт"
        >
          <option value="">Базовий (Golos Text)</option>
          <option value='"Commissioner", system-ui, sans-serif'>Commissioner (заголовки)</option>
          <option value='"Inter", system-ui, sans-serif'>Inter</option>
          <option value='"Golos Text", system-ui, sans-serif'>Golos Text</option>
