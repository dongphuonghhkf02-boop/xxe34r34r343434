        ...
        <aside style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <section className={styles.card}>
            ...
            <div className={styles.field}>
              ...
              <select className={styles.select} value={order.internal_status} onChange={(e) => onChangeInternal(e.target.value as InternalStatus)} disabled={busy}>
                {INTERNAL_OPTIONS.map((o) => <option key={o.v} value={o.v}>{o.label}</option>)}
              </select>
            </div>
            <dl className={styles.kv}>
