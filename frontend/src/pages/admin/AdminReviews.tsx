  ...
  return (
    <div className={styles.shell}>
      ...
      <div className={styles.filters}>
        ...
        >
          <option value="all">Виділені: всі</option>
          <option value="yes">На головній</option>
          <option value="no">Не на головній</option>
        </select>
        <select
          className={styles.filterSelect}
            ...
            <div className={styles.formGrid}>
              ...
              <label className={`${styles.field} ${styles.fieldWide}`}>
                ...
                <select
                  ...
                  onChange={(e) => updateDraft("product_id", e.target.value)}
                >
                  <option value="">— Без прив'язки (загальний відгук) —</option>
                  {products.map((p) => (
                    <option key={p.id} value={p.id}>
                      {p.name} ({p.slug})
                    </option>
